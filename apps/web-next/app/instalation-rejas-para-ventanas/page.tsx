  ...
  return (
    ...
    >
      <section className="mw-section mw-installation-toc" aria-labelledby="installation-toc-title">
        ...
        <nav aria-label="Índice de la guía de instalación">
          <ol>
            ...
            <li><a href="#revision-final">Revisión final y pequeños roces</a></li>
          </ol>
        </nav>
      </section>
      ...
      <section className="mw-section" id="antes-de-empezar">
        ...
        <p>
          Antes de empezar conviene tener el hueco medido y la posición de la reja clara. Si aún no has
        ...
        <ul className="mw-list">
          ...
          <li>Nivel para comprobar la posición de la reja.</li>
          <li>Rotulador para marcar los puntos de fijación.</li>
          <li>Medio para limpiar el polvo de los taladros.</li>
          <li>Cuñas o listones protegidos si necesitas pequeños ajustes de presentación.</li>
        </ul>
      </section>
      ...
      <section className="mw-section" id="revisa-la-reja">
        ...
        <aside className="mw-installation-callout" aria-label="Aviso antes de instalar">
          <p><strong>Si observas un golpe, desconchado o posible defecto antes de instalar:</strong> no lo retoques todavía.</p>
          <p>
      ...
      <section className="mw-section" id="instalacion">
        ...
        <ol className="mw-steps">
          ...
          <li>Comprueba nivel, aplomo y posición antes de marcar.</li>
          ...
          <li>Realiza la revisión final antes de retirar las protecciones restantes.</li>
        </ol>
      ...
      <section className="mw-section" id="revision-final">
        ...
        <p>
          ...
          <Link className="mw-inline-link" href="/mantenimiento-retoque-rejas-metalicas">

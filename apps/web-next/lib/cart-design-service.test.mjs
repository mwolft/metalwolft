...
assert.match(cartView, /Visualiza esta reja en \{designPreviewDimensions\} antes de hacer el pedido\./);
...
assert.match(styles, /\.mw-cart-design-preview\s*{[^}]*grid-template-columns:\s*2\.5rem minmax\(0, 1fr\);/s);

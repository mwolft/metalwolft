...
export const PuertasCorrederasInteriores = () => {
    ...
    useEffect(() => {
        ...
        fetch(`${apiBaseUrl}/api/seo/puertas-correderas-interiores`)
            .then((response) => {
                if (!response.ok) {
    ...
    return (
        <>
            <Helmet htmlAttributes={{ lang: metaData.lang || "es" }}>
                ...
                <meta property="og:image:alt" content={metaData.og_image_alt || "puertas correderas interiores"} />
            ...
            <div className="container" style={{ marginTop: "100px" }}>
                <Breadcrumb
                    items={[
                        { label: "Inicio", to: "/" },
                        { label: "Catálogo" },
                        { label: "Puertas Correderas Interiores" }
                    ]}
                />
                <div className="row">
                    <h1 className="h2-categories mb-3">Puertas Correderas Interiores</h1>
                    <div className="col-12 mb-3">
                        <p className="mb-0">
                            Si tambiÃ©n quieres reforzar la seguridad de tus ventanas, puedes explorar nuestras <Link to="/rejas-para-ventanas" className="link-categories">rejas para ventanas</Link>, consultar la <Link to="/medir-hueco-rejas-para-ventanas" className="link-categories">guÃ­a para medir el hueco</Link> y ver cÃ³mo funciona la <Link to="/instalation-rejas-para-ventanas" className="link-categories">instalaciÃ³n sin obra</Link>.
                        </p>
                    </div>
                    <div className="col-12 col-lg-3 col-xl-3 order-1">
                        {/*<AsideCategories
                            ...
                            categoryId={puertasCorrederasInterioresCategoryId}
                        />*/}
                        <div className="d-none d-lg-block">
                            <AsidePost />
                            <AsideOthersCategories currentCategoryId={puertasCorrederasInterioresCategoryId} />
                        </div>
                    </div>

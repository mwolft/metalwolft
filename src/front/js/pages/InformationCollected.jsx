    ...
    return (
        <>
            ...
            <div className="container" style={{ marginTop: '65px' }}>
                ...
                <p>
                    En Metal Wolft, recopilamos información para mejorar tu experiencia de usuario
                    y para gestionar correctamente los pedidos y servicios que ofrecemos.
                </p>

                <h2 className="h2-categories mb-3">Tipos de Información Recopilada</h2>
                <ul>
                    <li><strong>Información no personal:</strong> Recopilamos datos de navegación, direcciones IP y cookies para analizar el tráfico y mejorar nuestra plataforma.</li>
                    <li><strong>Información personal:</strong> Al registrarte o comprar recopilamos datos como nombre, correo, dirección y teléfono.</li>
                </ul>

                <h2 className="h2-categories mb-3">Uso de la Información</h2>
                <ul>
                    <li>Procesar tus pedidos.</li>
                    <li>Ofrecerte experiencia personalizada.</li>
                    <li>Enviar notificaciones del estado de tus pedidos.</li>
                </ul>

                <h2 className="h2-categories mb-3">Consentimiento y Derechos del Usuario</h2>
                <p>Tienes derecho a solicitar acceso, corrección o eliminación de tus datos en cualquier momento.</p>

                <h2 className="h2-categories mb-3">Actualización de la Información</h2>
                <p>Esta política puede actualizarse para reflejar cambios en nuestras prácticas.</p>

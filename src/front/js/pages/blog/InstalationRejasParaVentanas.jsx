                    ...
                    <Col xl={9}>
                        {currentPost && (
                            <div className="single_post">
                                ...
                                <img src="https://www.metalwolft.com/assets/images/blog/rejas-de-seguridad-para-ventanas.avif" alt="es" className="img-fluid my-3" />
                            </div>
                        )}
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="single_img">
                                        <img class="w-100 mb-4" src="https://www.metalwolft.com/assets/images/blog/rejas-para-ventanas-modernas-2023.avif" alt="rejas para ventanas modernas" />
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="single_img">
                                        <img class="w-100 mb-4" src="https://www.metalwolft.com/assets/images/blog/rejas-para-ventanas-sin-obra-precio.avif" alt="rejas para ventanas sin obra" />
                                    </div>
                                </div>
                            </div>

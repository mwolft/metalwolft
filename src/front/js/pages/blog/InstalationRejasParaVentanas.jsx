                ...
                <Row>
                    <Col xl={9}>
                        ...
                        <div className="blog-text">
                            <p>Antes de instalar, te vendrá bien revisar la <Link to="/medir-hueco-rejas-para-ventanas" style={{ color: '#ff324d', textDecoration: 'underline' }}>guí­a para medir el hueco</Link> y comparar nuestras <Link to="/rejas-para-ventanas-sin-obra" style={{ color: '#ff324d', textDecoration: 'underline' }}>rejas para ventanas sin obra</Link> y los modelos de <Link to="/rejas-para-ventanas-modernas" style={{ color: '#ff324d', textDecoration: 'underline' }}>rejas modernas</Link>.</p>

                ...
                <Row>
                    <Col xl={9}>
                        ...
                        <div className="blog-text">
                            <p>Para acertar a la primera, te vendrá bien revisar <Link to="/medir-hueco-rejas-para-ventanas" style={{ color: "#ff324d", textDecoration: "underline" }}>cómo medir el hueco</Link> y seguir nuestra <Link to="/instalation-rejas-para-ventanas" style={{ color: "#ff324d", textDecoration: "underline" }}>guí­a de instalación sin obra</Link>.</p>

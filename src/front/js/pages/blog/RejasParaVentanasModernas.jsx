                ...
                <Row>
                    <Col xl={9}>
                        ...
                        <div className="blog-text">
                            <p>Si además buscas una instalación limpia, puedes comparar estos diseños con nuestras <Link to="/rejas-para-ventanas-sin-obra" style={{ color: "#ff324d", textDecoration: "underline" }}>rejas para ventanas sin obra</Link> y revisar <Link to="/medir-hueco-rejas-para-ventanas" style={{ color: "#ff324d", textDecoration: "underline" }}>cómo medir el hueco</Link> antes de pedir precio.</p>

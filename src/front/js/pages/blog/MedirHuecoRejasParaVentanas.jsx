                    ...
                    <Col xl={9}>
                        {currentPost && (
                            <div className="single_post">
                                ...
                                <img src="https://res.cloudinary.com/dewanllxn/image/upload/v1733562847/rejas-para-ventanas_ttjq3d.avif" alt="rejas para ventanas" className="img-fluid my-3 post-hero-image" />
                            </div>
                        )}
                        <div className="blog-text">
                            <p>Si después vas a optar por <Link to="/rejas-para-ventanas-sin-obra" style={{ color: '#ff324d', textDecoration: 'underline' }}>rejas para ventanas sin obra</Link>, te recomendamos tener también a mano nuestra <Link to="/instalation-rejas-para-ventanas" style={{ color: '#ff324d', textDecoration: 'underline' }}>guí­a de instalación sin obra</Link>.</p>
